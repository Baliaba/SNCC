...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/Rapport_Curatif.css"/>
 </head>
<body>
    <div class="container">
        <div class="row">
                ...
                <div class="row" id="Div_Content">
                    ...
                    <div class="col-md-8" id="Div_View">
                        ...
                        <div class="row" id="Table_Zone">
                            <div class="col-md-12">
                                <table class="table table-stripped" id="Table_Curatif">
                                    <tr>
                                        <th>DATE</th>
                                        <th>OBJET</th>
                                        <th>FICHIER</th>
                        ...
                        <div class="row bottom" id="Action_Zone">
                            <div class="col-md-12">
                                ...
                                <table>
                                    <tr>
                                        <td><button type="button" class="btn btn-primary" id="Btn_Rapport_Curatif_Edit">MODIFIER</button></td>
                                        <td><button type="button" class="btn btn-danger" id="Btn_Rapport_Curatif_Delete">SUPPRIMER</button></td>
                                    </tr>
                                </table>';}
    ...
    <script type="text/javascript" src="script/My/Rapport_Curatif.js"></script>
</body>
</html>