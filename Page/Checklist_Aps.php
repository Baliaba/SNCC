...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/ChecklistAps.css"/>
 </head>
<body>
    <div class="container">
        <div class="row">
                ...
                <div class="row" id="Div_Content">
                    ...
                    <div class="col-md-8" id="Div_View">
                        ...
                        <div class="row" id="Table_Zone">
                            <div class="col-md-12">
                                <table class="table" border="0" id="Table_Aps">
                                    <tr>
                                        <th>T°C</th>
                                        <th>VCC</th>
                                        <th>VB</th>
                        ...
                        <div class="row bottom" id="Action_Zone">
                            <?php
                               ...
                               <table>
                                   <tr>
                                       <td><button type="button" class="btn btn-primary" id="Btn_Checklist_Aps_Edit">MODIFIER</button></td>
                                       <td><button type="button" class="btn btn-danger" id="Btn_Checklist_Aps_Delete">SUPPRIMER</button></td>
                                   </tr>
                               </table>';}
                            ?>
                        </div>
    ...
    <script type="text/javascript" src="script/My/CheckList_Aps.js"></script>
</body>
</html>